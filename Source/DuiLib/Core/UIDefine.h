...
#define DUI_MSGTYPE_SETCURSOR				(_T("setcursor"))
...
//<By Jackie 2013-6-9>鼠标左右键消息.
#define DUI_MSGTYPE_BUTTONDOWN 		   		(_T("buttondown"))
#define DUI_MSGTYPE_BUTTONUP				(_T("buttonup"))
#define DUI_MSGTYPE_LBUTTONDOWN				(_T("lbuttondown"))
#define DUI_MSGTYPE_RBUTTONDOWN				(_T("rbuttondown"))
#define DUI_MSGTYPE_LBUTTONUP				(_T("lbuttonup"))
#define DUI_MSGTYPE_RBUTTONUP				(_T("rbuttonup"))
#define DUI_MSGTYPE_LBUTTONDBCLICK			(_T("lbuttondbclick"))
#define DUI_MSGTYPE_RBUTTONDBCLICK			(_T("rbuttondbclick"))
...
#define DUI_MSGTYPE_MOUSEWHEEL				(_T("mousewheel"))
